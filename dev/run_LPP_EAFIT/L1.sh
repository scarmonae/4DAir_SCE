...
ANALYSIS_SCRIPT_DIR="/home/medico_eafit/WORKSPACES/sebastian_carmona/REPOSITORIOS/LPP/Lidar_Analysis_PDL1/"
...
process_day() {
    local day_dir="$1"
    # printf "%s\n" "$day_dir"
    sudo ./lidarAnalysis_PDL1 "${day_dir}/LPP/L0.nc" "${day_dir}/LPP/L1.nc" "/home/medico_eafit/WORKSPACES/sebastian_carmona/data/EAFIT/analysisParameters_Medellin_jp.conf" #|| printf "Error processing directory: %s\n" "$day_dir" >&2
}
